...
--> statement-breakpoint
CREATE TABLE "technonlogy" (
	"id" varchar(36) PRIMARY KEY NOT NULL,
	"name" varchar(25) NOT NULL,
	CONSTRAINT "technonlogy_id_unique" UNIQUE("id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "bugs" ADD CONSTRAINT "bugs_technology_id_technonlogy_id_fk" FOREIGN KEY ("technology_id") REFERENCES "public"."technonlogy"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
